#ifndef VENDING_MACHINE_DOMAIN_INTERFACES_IPAYMENT_GATEWAY_HPP
#define VENDING_MACHINE_DOMAIN_INTERFACES_IPAYMENT_GATEWAY_HPP
...
#endif // VENDING_MACHINE_DOMAIN_INTERFACES_IPAYMENT_GATEWAY_HPP
